...
exports.wakingnightmare = void 0;
exports.wakingnightmare = [
    [
    ...
    ],
    {
        points: [
            [
                "Some cards tell you to “have a Waking Nightmare.” This means ",
                { bold: "“Discard a non-grey Hero from your hand. If you discard a Hero this way, draw a card.”" }
            ],
            [
